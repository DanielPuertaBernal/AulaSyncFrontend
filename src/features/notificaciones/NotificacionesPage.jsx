...
import { Bell, RefreshCw, MailCheck, MailX, Clock, ExternalLink } from 'lucide-react';
...
export default function NotificacionesPage() {
  ...
  const COLS = [
    ...
    { key: 'enviado_por', label: 'Enviado por' },
    {
      ...
      label: 'Contexto',
      render: (v) => v
        ? <Link to="/llaves" title="Ver préstamos de llaves" className="inline-flex items-center gap-1 text-primary hover:underline text-xs"><ExternalLink className="h-3 w-3" />Llaves</Link>
